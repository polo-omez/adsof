...
public class EjemploUsoRedSocial {
  ...
  public static void main(String[] args) {
    try {
      ...
      RedSocial s = new RedSocial("txt/USUARIOS.txt", "txt/ENLACES.txt", "txt/MENSAJE.txt");

      // Probamos la FACHADA, añadiendo algo manualmente
      s.registrarUsuario("pablo", 10);
      s.crearEnlace("diego", "pablo", 2);
      System.out.println("Usuario 'pablo' añadido y conectado desde 'diego'.");

      // Probamos la PERSISTENCIA, guardamos el estado actual
      s.guardarRed("txt/USUARIOS_BACKUP.txt", "txt/ENLACES_BACKUP.txt", "txt/MENSAJES_BACKUP.txt");
      ...
      // Capturamos cualquier error de lectura/escritura y mostramos el mensaje del
      // PDF
